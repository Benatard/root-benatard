...
('a0000000-0000-4000-8000-000000000002', 'Câblage réseau — Hôpital SKK', 'Infrastructure Réseau', '2024', '/images/services/infra-it.svg', 'Direction d''une équipe IT pour le câblage et la connectique du bâtiment de 4 niveaux de l''Hôpital SKK, jusqu''à la mise en service.', '["Câblage structuré","Réseau LAN","Gestion d''équipe"]'::jsonb, '#', '#', 2),
('a0000000-0000-4000-8000-000000000003', 'Supervision IT — Chantier 5 niveaux', 'Infrastructure Réseau', '2024', '/images/services/maintenance.svg', 'Direction d''une équipe IT sur un chantier d''un bâtiment de 5 niveaux : supervision réseau, installation des postes et coordination des intervenants.', '["Supervision réseau","Câblage","Postes & périphériques"]'::jsonb, '#', '#', 3),
('a0000000-0000-4000-8000-000000000005', 'Architecture réseau & maintenance', 'Infrastructure Réseau', '2023', '/images/services/maintenance.svg', 'Assistance au design de l''architecture réseau du bâtiment d''Umoja Industry, puis maintenance préventive du parc informatique pendant 1 mois.', '["Architecture réseau","Maintenance préventive","Support utilisateurs"]'::jsonb, '#', '#', 4),
('a0000000-0000-4000-8000-000000000006', 'Applications web Full-Stack', 'Développement web', '2023', '/images/services/dev-software.svg', 'Conception et développement d''applications web complètes : front-end (React, Tailwind CSS), back-end (Node.js) et design UI/UX intégrés.', '["React","Tailwind CSS","Node.js","UI/UX"]'::jsonb, '#', '#', 5),
('a0000000-0000-4000-8000-000000000004', 'Déploiement d''un système hospitalier', 'Système hospitalier', '2022', '/images/services/dev-software.svg', 'Participation au déploiement d''un système hospitalier local chez Umoja Industry : installation, configuration et formation des agents à l''utilisation du logiciel et du système complet.', '["Node.js","Bases de données","Réseau local","Formation utilisateurs"]'::jsonb, '#', '#', 6);
